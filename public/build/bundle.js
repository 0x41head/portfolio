    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-jxxdkc");
    			add_location(img0, file$3, 89, 4, 1959);
    			attr_dev(button0, "class", "applicationBtnClass svelte-jxxdkc");
    			add_location(button0, file$3, 88, 0, 1897);
    			if (!src_url_equal(img1.src, img1_src_value = "./icon.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "svelte-jxxdkc");
    			add_location(img1, file$3, 93, 4, 2064);
    			attr_dev(button1, "class", "applicationBtnClass svelte-jxxdkc");
    			add_location(button1, file$3, 92, 0, 2003);
    			attr_dev(div, "class", "applicationLauncher svelte-jxxdkc");
    			add_location(div, file$3, 83, 0, 1777);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "applicationLauncherImgClass svelte-jxxdkc");
    			add_location(img, file$3, 100, 8, 2237);
    			attr_dev(button, "class", "applicationLauncherBtnClass svelte-jxxdkc");
    			add_location(button, file$3, 99, 4, 2149);
    			attr_dev(div, "class", "bottomBar svelte-jxxdkc");
    			add_location(div, file$3, 98, 0, 2121);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 72, 2, 1164);
    			attr_dev(div0, "class", "topbar svelte-1cujahq");
    			add_location(div0, file$2, 70, 1, 1132);
    			attr_dev(div1, "class", "text svelte-1cujahq");
    			add_location(div1, file$2, 78, 1, 1272);
    			...
    			add_location(section, file$2, 63, 0, 990);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$1, 42, 4, 904);
    			attr_dev(button0, "class", "btn svelte-lbqljc");
    			add_location(button0, file$1, 41, 0, 858);
    			add_location(br, file$1, 45, 0, 948);
    			if (!src_url_equal(img1.src, img1_src_value = "./icon.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "svelte-lbqljc");
    			add_location(img1, file$1, 47, 4, 999);
    			attr_dev(button1, "class", "btn svelte-lbqljc");
    			add_location(button1, file$1, 46, 0, 954);
    			attr_dev(div, "class", "iconList svelte-lbqljc");
    			add_location(div, file$1, 40, 0, 835);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
